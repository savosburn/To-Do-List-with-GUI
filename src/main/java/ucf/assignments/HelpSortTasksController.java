...
public class HelpSortTasksController {
    ...
    @FXML
    void initialize() {
        assert returnButton != null : "fx:id=\"returnButton\" was not injected: check your FXML file 'HelpSortTasksController.fxml'.";
        assert backButton != null : "fx:id=\"backButton\" was not injected: check your FXML file 'HelpSortTasksController.fxml'.";
